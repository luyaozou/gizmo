...
dpfit: calfit.o subfit.o dpi.o splib.a; gcc -no-pie -o $@ $^ $(BLASLIB) -lm
dpcat: calcat.o sortsub.o dpi.o splib.a; gcc -no-pie -o $@ $^ $(BLASLIB) -lm
spfit: calfit.o subfit.o spinv.o spinit.o splib.a; gcc -no-pie -o $@ $^ $(BLASLIB) -lm
spcat: calcat.o sortsub.o spinv.o spinit.o splib.a; gcc -no-pie -o $@ $^ $(BLASLIB) -lm
calmrg: calmrg.o splib.a; gcc -no-pie -o $@ $^ $(BLASLIB) -lm
calbak: calbak.o splib.a; gcc -no-pie -o $@ $^ $(BLASLIB) -lm
termval: termval.o splib.a; gcc -no-pie -o $@ $^ $(BLASLIB) -lm
stark: stark.o splib.a ; gcc -no-pie -o $@ $^ $(BLASLIB) -lm
moiam: moiam.o ftran.o splib.a; gcc -no-pie -o $@ $^ $(BLASLIB) -lm
iamcalc: iamcalc.o ftran.o readopt.o splib.a; gcc -no-pie -o $@ $^ $(BLASLIB) -lm
sortn: sortn.o sortsub.o; gcc -no-pie -o $@ $^
reassign: reassign.o splib.a ; gcc -no-pie -o $@ $^ $(BLASLIB) -lm
sortegy:  sortegy.o splib.a ; gcc -no-pie -o $@ $^ $(BLASLIB) -lm
iambak:  iambak.o splib.a readopt.o ; gcc -no-pie -o $@ $^ $(BLASLIB) -lm
